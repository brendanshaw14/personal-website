        ...
        <div>
            <div className='hobbies-intro-container'>
                <Fade triggerOnce fraction={0.5} duration={1000}>
                    <div className='hobbies-intro-text'>
                        <h1>Hobbies</h1>
            ...
            <div className='hobbies-content-container'>
                ...
                <div className='sports-container'>
                    <Fade triggerOnce cascade='true' fraction={0.5} duration={1000} damping={0.1}>
                ...
                <div className='album-container'>
                    <Fade triggerOnce cascade='true' fraction={0.5} duration={1000}>
                    ...
                    <div className='album-content-container'>
                        ...
                        <iframe className="album" title="Work From Home" src="https://open.spotify.com/embed/album/0ORKsWALEps4PNvnM78dM7?utm_source=generator" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
                        <iframe className="album" title="Salad Days" src="https://open.spotify.com/embed/album/2sij95QgjmgrhNv33achzn?utm_source=generator" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
                        <iframe className="album" title="The Miseducation of Lauryn Hill" src="https://open.spotify.com/embed/album/1BZoqf8Zje5nGdwZhOjAtD?utm_source=generator&theme=0" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
                    </div>
                </div>
            </div>
        </div>
